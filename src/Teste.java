...
public class Teste {
    public static void main(String args[]){
        ...
        Processo p2 = new Processo(2, 3, 0, 0);
        Processo p3 = new Processo(3, 3, 0, 0);
        ...
        Processo p5 = new Processo(2, 17, 0, 0);
        Processo p6 = new Processo(3, 68, 0, 0);
        Processo p7 = new Processo(4, 24, 0, 0);
